...
//From Demo code of lab10 created by Dr. Sally, used without midification//
...
/** Comparison function that must work like strcmp.
 ...
 * @param pPredecessor Used to return the previous item so 
 *       we can unlink the minimum
 * @return A pointer to the minimum item, or null if the queue is empty.
 */
